...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
        <form method="POST" class="needs-validation" id="file_import_form" action="{{ route('admin.test_center.save') }}" enctype="multipart/form-data" novalidate>
        ...
        $("#file_import_form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    waitingDialog.show('กำลังนำเข้ารายชื่อศูนย์สอบ...', {
                        onShow: function() {
